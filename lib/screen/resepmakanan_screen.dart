...
import 'package:resepmakanan/cubit/resepmakanan_cubit.dart';
import 'package:resepmakanan/screen/detail_resep_makananscreen.dart';
...
class _ResepMakananScreenState extends State<ResepMakananScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
         title: Center(
          child:Text("NIM : 191011450112 - NAMA : SULTAN RAFLY S")
          ,)
      ),
